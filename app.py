...
if st.button("Generate Bio-Age Report"):
    ...
    <body>
        <div class="header">
            ...
            <div class="bar-bg" style="background-color: #233554; border-radius: 15px; height: 20px; width: 100%; margin: 15px 0;"><div class="bar-fill" style="background-color: {gauge_color}; width: {gauge_percent}%; height: 100%; border-radius: 15px;"></div></div>
            <div style="color: {gauge_color}; font-weight: bold; font-size: 16px; text-align: center;">{gauge_label}</div>
            <div style="font-size: 12px; color: #8892b0; margin-top: 4px; text-align: center;">Calculated Biological Deviation Delta: {round(age_delta, 1)} Years</div>
        </div>
